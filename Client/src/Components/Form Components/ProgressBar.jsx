...
const ProgressBar = ({ step }) => {
  return (
    ...
    <div className="progress-bar-container px-6 py-4 md:px-8 md:py-6 flex items-center justify-center gap-2 md:gap-3 rounded-lg shadow-[0_0_5px_gray] bg-[#ff0000]">
        ...
        <div className="third-part relative flex items-center">
          ...
          ></section>
          {/* <section className={`bar w-52 h-2 ${step >= 3 ? 'bg-[#ff0000]' : 'bg-white'} rounded-lg transition-colors duration-150 ease-linear`}></section> */}
        </div>
      </div>
    </div>
  );
